...
parser.add_argument('--finetune-from', type=str, default='model/VGG_FC_ILSVRC_16_layers-0074',
...
# network
import importlib
net = importlib.import_module('symbol_vgg').get_symbol(args.num_classes, args.dataset)
...
def get_iterator(args, kv):
    ...
    train = mx.io.ImageRecordIter(
        ...
        rand_crop   = True,
        rand_mirror = True,
        # max_rotate_angle = 15, #random rotate 10 degrees
